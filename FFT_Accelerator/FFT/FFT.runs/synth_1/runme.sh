...
HD_PWD='/home/omkar/FFT_Accelerator/FFT/FFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_nm32_audio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_nm32_audio.tcl
