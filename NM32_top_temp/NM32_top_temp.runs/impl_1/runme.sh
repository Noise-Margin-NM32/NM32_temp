...
HD_PWD='/home/omkar/SoC_0.1/NM32_top_temp/NM32_top_temp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ef_util_clkmux_4x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ef_util_clkmux_4x1.tcl -notrace
